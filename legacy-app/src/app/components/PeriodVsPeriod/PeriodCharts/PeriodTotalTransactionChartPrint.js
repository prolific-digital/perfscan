...
import { fetchAsyncPeriodTotalTransaction, getPeriodTotalTransactionsData } from "../../../../store/slices/periodVsPeriodCharts/periodCharts/periodOtherChartsSlice";
...
const PeriodTotalTransactionChartPrint = (syncHandler) => {
    const dispatch = useDispatch();
    const totalTransactionData = useSelector(getPeriodTotalTransactionsData);
    ...
    useEffect(() => {
        dispatch(fetchAsyncPeriodTotalTransaction(pqd));
    }, [dispatch])
                                ...
                                <tr>
                                    {!_.isEmpty(totalTransactionData.data[0].data) &&
                                        <ChartView
                                            ...
                                            xAxisDateFormat={totalTransactionData1[0].xValueFormatString}
                                            isVisible={true} 
                                            showTotal={true}
                                            minimum={0}
                                            maximum={max}
                                ...
                                <tr>
                                    {!_.isEmpty(totalTransactionData.data[1].data) &&
                                        <ChartView
                                            ...
                                            subtitle={period2}
                                            yAxisTitle={"Transactions"}
                                            xAxisDateFormat={totalTransactionData2[0].xValueFormatString}
                                            isVisible={true}
                                            showTotal={true}
                                            minimum={0}
                                            maximum={max}
...
export default PeriodTotalTransactionChartPrint;