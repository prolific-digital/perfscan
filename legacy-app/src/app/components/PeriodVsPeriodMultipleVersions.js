...
function PeriodVsPeriodMultipleVersions(props) {
  const [dataTableLoop, setDataTableLoop] = useState([1,2,3,4,5,6])
  ...
  return (
    <>
      ...
      {/* <div style={{display:"flex", overflow:'auto'}}> */}
        {/* {props.versionsList.map((res)=>{
          return (
            <DataTable
            value= {props.allExecutiveDataSets}       //{executiveReports.cpu}
            header= {renderHeader1} //  Version V1 (April 1, 2021)
            PeriodHeaderDetails
            stripedRows
            showGridlines
            responsiveLayout="scroll"
            tableStyle={{width:'maxContent'}}
          >
            <Column
              field="dtypedesc"
              header="Core Metric	"
...
export default PeriodVsPeriodMultipleVersions
