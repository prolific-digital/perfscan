...
import {
  fetchAsyncReadWriteRatio,
  getDiskReadWriteData,
...
const DiskReadWriteRatio = ({ activeChartView }) => {
  ...
  const systemName = diskReadWriteRatioData?.data?.params?.server?.split(" ");
  ...
  useEffect(() => {
    if (
      diskReadWriteRatioData.loading === false &&
          ...
          <div className="chart_container">
            {activeChartView.isMetricsChart && (
              <ChartView
                ...
                xAxisDateFormat={
                  DiskReadWriteRatioMetrics[0].xValueFormatString
                }
                isVisible={activeChartView.isMetricsChart}
                showTotal={false}
                minimum={0}
                stripLineToggle={activeChartView.isShowGuidelines}
                criticalUtilizationValue={diskReadWriteRatioData}
                metricType={"read_write_ratio"}
              />
            )}
            ...
            <div className="chat_main1">
              ...
              <div style={{ textAlign: "center" }}>
                ...
                <img
                  ...
                  src="/noData.webp"
                  alt="No data available for Disk Read Write Ratio."
                />
              </div>
            </div>
            <div className="chat_main1">
...
export default React.memo(DiskReadWriteRatio);
