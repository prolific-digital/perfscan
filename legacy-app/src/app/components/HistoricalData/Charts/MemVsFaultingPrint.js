...
import { fetchAsyncMemorySizeVsFaulting, getMemoryVsFaultingData } from "../../../../store/slices/charts/memoryChartsSlice";
import useQueryData from "../../../../hooks/useQueryDataHistorical";
import {
  createChartDataMapping , getDataPointsForPoolNumBasedCharts
...
const MemVsFaultingPrint = ({ activeChartView }) => {
...
export default (MemVsFaultingPrint);