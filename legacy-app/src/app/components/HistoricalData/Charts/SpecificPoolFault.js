...
import {
  fetchAsyncSpecificPoolFaulting,
  getSpecificPoolFaultingData,
...
const SpecificPoolFault = ({ activeChartView }) => {
  ...
  const systemName = specificFaultData?.data?.params?.server?.split(" ");
  ...
  useEffect(() => {
    if (specificFaultData?.data?.data) {
      createChartDataMappingForSpecificPoolFaulting("All");
    }

    if (
      specificFaultData.loading === false &&
      !_.isEmpty(specificFaultData.data.data)
    ) {
  ...
  const createChartDataMappingForSpecificPoolFaulting = async (indx) => {
            ...
            <>
              <span className="chart_dropDown">
                ...
                <Dropdown
                  ...
                  onChange={(e) =>
                    createChartDataMappingForSpecificPoolFaulting(e.value)
                  }
            ...
            <div className="chart_container">
              {activeChartView.isMetricsChart && (
                <ChartView
                  ...
                  criticalUtilizationValue={specificFaultData}
                  metricType={"pool_faulting_rate"}
            ...
            <div className="chat_main1">
              ...
              <div style={{ textAlign: "center" }}>
                ...
                <img
                  ...
                  src="/noData.webp"
                  alt="No data available for Specific Pool Fault."
                />
              </div>
            </div>
            <div className="chat_main1">
...
export default React.memo(SpecificPoolFault);
