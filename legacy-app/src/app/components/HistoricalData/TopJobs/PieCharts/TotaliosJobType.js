...
import {
  fetchAsyncTotalIOsTopJobsChart,
  getTotalIOsTopJobsChartData,
...
import {
  fetchAsyncRealTimeTotalIOsTopJobsChart,
  getRealTimeTotalIOsTopJobsChartData,
} from "../../../../../store/slices/topJobs/topJobsRealTimeMonitorSlice";

const CanvasJSChart = CanvasJSReact.CanvasJSChart;

const TotaliosJobType = ({ runReportStateValue, print, alertPage }) => {
  let qd = null;
  ...
  useEffect(() => {
    if (!uuid?.loading && uuid.data.uniqueid && !alertPage) {
      dispatch(fetchAsyncTotalIOsTopJobsChart(qd));
    }
    if (alertPage)
      dispatch(
        fetchAsyncRealTimeTotalIOsTopJobsChart({
