...
import {
  fetchAsyncTopJobsChartAsyncIOs,
  getAsyncIOsTopJobsChartData,
...
import {
  fetchAsyncRealTimeTopJobsChartAsyncIOs,
  getRealTimeAsyncIOsTopJobsChartData,
} from "../../../../../store/slices/topJobs/topJobsRealTimeMonitorSlice";

const CanvasJSChart = CanvasJSReact.CanvasJSChart;
const AsynciosJobType = ({ runReportStateValue, print, alertPage }) => {
  let qd = null;
  ...
  useEffect(() => {
    if (!uuid?.loading && uuid.data.uniqueid && !alertPage) {
      dispatch(fetchAsyncTopJobsChartAsyncIOs(qd));
    }
    if (alertPage)
      dispatch(
        fetchAsyncRealTimeTopJobsChartAsyncIOs({
